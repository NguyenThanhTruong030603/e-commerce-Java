package NguyenThanhTruong.com.shop;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/register", "/error",
                                "/products", "/images/**" , "/products/search","/products/autocomplete" /*, "/cart", "/cart/** "*/)
                        .permitAll() // Cho phép truy cập không cần xác thực.
                        .requestMatchers("/products/edit/**", "/products/add", "/products/delete" ,"/products/ql" ,"categories/add" , "/user" , "/order" ,"order/{orderId}")
